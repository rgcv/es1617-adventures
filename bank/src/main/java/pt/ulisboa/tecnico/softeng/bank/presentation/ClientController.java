...
public class ClientController {
	...
	public String clientForm(Model model, @PathVariable String bankCode) {
		logger.info("clientForm code: {}", bankCode);
	...
	public String clientSubmit(Model model, @PathVariable String bankCode,@ModelAttribute ClientData clientData) {
		logger.info("clientSubmit bankCode:{}, name:{}", bankCode, clientData.getName());
